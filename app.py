...
with mysql.connector.connect(host="localhost",user="root",password="system",database="flaskblog"):
    ...
    cursor.execute("create table if not exists registration(username varchar(50) primary key,mobile varchar(30) unique,email varchar(40) unique,address varchar(60),password varchar(20))")
